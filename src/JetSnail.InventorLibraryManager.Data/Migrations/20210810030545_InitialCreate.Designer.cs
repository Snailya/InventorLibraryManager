...
namespace JetSnail.InventorLibraryManager.Data.Migrations
{
    ...
    [Migration("20210810030545_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JetSnail.InventorLibraryManager.Core.Entities.DerivativeFamilyEntity", b =>
                {
                    ...
                    b.Property<int?>("PrototypeEntityId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JetSnail.InventorLibraryManager.Core.Entities.DerivativeFamilyEntity", b =>
                {
                    b.HasOne("JetSnail.InventorLibraryManager.Core.Entities.PrototypeFamilyEntity", "PrototypeEntity")
                        .WithMany("Derivatives")
                        .HasForeignKey("PrototypeEntityId");

                    b.Navigation("PrototypeEntity");
                });
